 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/GameDataPK9.cs
 * GPL v3 License
...
/// </summary>
public sealed class GameData3PK9 : HomeOptional3, IGameDataSide3<PK9>, IScaledSize3, IGameDataSplitAbility
{
    ...
    public GameData3PK9() : base(SIZE) { }
    public GameData3PK9(Memory<byte> data) : base(data) => EnsureSize(SIZE);
    public GameData3PK9 Clone() => new(ToArray());
    ...
    public void CopyTo(PK9 pk, PH3 pkh)
    {
        this.CopyTo(pk);
        pk.Scale = Scale;
    ...
    public void CopyFrom(PK9 pk, PH3 pkh)
    {
        this.CopyFrom(pk);
    ...
    public PK9 ConvertToPKM(PH3 pkh)
    {
        var pk = new PK9();
        pkh.CopyTo(pk);
        CopyTo(pk, pkh);
    ...
    public static GameData3PK9? TryCreate(PH3 pkh)
    {
    ...
    private static GameData3PK9? CreateInternal(PH3 pkh)
    {
        var side = GetNearestNeighbor(pkh);
        if (side is null)
            return null;

        var result = new GameData3PK9();
        result.InitializeFrom(side, pkh);
        return result;
    }

    private static IGameDataSide3? GetNearestNeighbor(PH3 pkh) => pkh.DataPK8 as IGameDataSide3
