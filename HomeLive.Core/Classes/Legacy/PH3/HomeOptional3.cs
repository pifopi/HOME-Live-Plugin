 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/HomeOptional1.cs
 * GPL v3 License
...
/// </summary>
public abstract class HomeOptional3
{
    ...
    protected HomeOptional3([ConstantExpected] ushort size) => Buffer = new byte[size];
    protected HomeOptional3(Memory<byte> buffer) => Buffer = buffer;
