 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/IGameDataSide.cs
 * GPL v3 License
...
public interface IGameDataSide3<T> : IGameDataSide3 where T : PKM, new()
{
    /// <summary>
    ...
    /// <param name="pkh">Overall HOME data object</param>
    void CopyFrom(T pk, PH3 pkh);

    /// <summary>
    /// Converts the data to a <see cref="PKM"/>.
    /// </summary>
    /// <param name="pkh">Overall HOME data object</param>
    T ConvertToPKM(PH3 pkh);
    ...
    /// <param name="pkh">Overall HOME data object</param>
    void InitializeFrom(IGameDataSide3 other, PH3 pkh);
}

/// <summary>
/// Common properties stored by HOME's side game data formats.
/// </summary>
public interface IGameDataSide3
{
    ushort Move1 { get; set; }
    int Move1_PP { get; set; }
    int Move1_PPUps { get; set; }
    ushort RelearnMove1 { get; set; }
    ushort Move2 { get; set; }
    int Move2_PP { get; set; }
    int Move2_PPUps { get; set; }
    ushort RelearnMove2 { get; set; }
    ushort Move3 { get; set; }
    int Move3_PP { get; set; }
    int Move3_PPUps { get; set; }
    ushort RelearnMove3 { get; set; }
    ushort Move4 { get; set; }
    int Move4_PP { get; set; }
    int Move4_PPUps { get; set; }
    ushort RelearnMove4 { get; set; }
    byte Ball { get; set; }
...
public static class GameDataSideExtensions3
{
    extension(IGameDataSide3 data)
    {
        /// <summary>
        ...
        /// </summary>
        /// <param name="pk">Destination entity</param>
        public void CopyTo(IGameDataSide3 pk)
        {
            pk.Move1 = data.Move1; pk.Move1_PP = data.Move1_PP; pk.Move1_PPUps = data.Move1_PPUps; pk.RelearnMove1 = data.RelearnMove1;
            pk.Move2 = data.Move2; pk.Move2_PP = data.Move2_PP; pk.Move2_PPUps = data.Move2_PPUps; pk.RelearnMove2 = data.RelearnMove2;
            pk.Move3 = data.Move3; pk.Move3_PP = data.Move3_PP; pk.Move3_PPUps = data.Move3_PPUps; pk.RelearnMove3 = data.RelearnMove3;
