 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/GameDataPA9.cs
 * GPL v3 License
...
/// </summary>
public sealed class GameData3PA9 : HomeOptional3, IGameDataSide3<PA9>, IScaledSize3, IGameDataSplitAbility, IAlpha
{
    ...
    public GameData3PA9() : base(SIZE) { }
    public GameData3PA9(Memory<byte> data) : base(data) => EnsureSize(SIZE);
    public GameData3PA9 Clone() => new(ToArray());
    ...
    internal const int PlusCount0 = 264;
    ...
    internal const int PlusCount1 = 96;
    ...
    public void CopyTo(PA9 pk, PH3 pkh)
    {
        this.CopyTo(pk);
        pk.Scale = Scale;
    ...
    public void CopyFrom(PA9 pk, PH3 pkh)
    {
        this.CopyFrom(pk);
    ...
    public PA9 ConvertToPKM(PH3 pkh)
    {
        var pk = new PA9();
        pkh.CopyTo(pk);
        CopyTo(pk, pkh);
    ...
    public static GameData3PA9? TryCreate(PH3 pkh)
    {
    ...
    private static GameData3PA9? CreateInternal(PH3 pkh)
    {
        var side = GetNearestNeighbor(pkh);
        if (side is null)
            return null;

        var result = new GameData3PA9();
