 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/GameDataPK8.cs
 * GPL v3 License
...
/// </summary>
public sealed class GameData3PK8 : HomeOptional3, IGameDataSide3<PK8>, IGigantamax, IDynamaxLevel, ISociability, IGameDataSplitAbility, IPokerusStatus
{
    ...
    public GameData3PK8() : base(SIZE) { }
    public GameData3PK8(Memory<byte> buffer) : base(buffer) => EnsureSize(SIZE);
    public GameData3PK8 Clone() => new(ToArray());
    ...
    public void CopyTo(PK8 pk, PH3 pkh)
    {
        this.CopyTo(pk);
    ...
    public void CopyFrom(PK8 pk, PH3 pkh)
    {
        this.CopyFrom(pk);
    ...
    public void CopyFrom(PK7 pk, PH3 pkh)
    {
        this.CopyFrom(pk);
        PokerusState = pk.PokerusState;
        AbilityNumber = (byte)pk.AbilityNumber;
    ...
    public PK8 ConvertToPKM(PH3 pkh)
    {
        var pk = new PK8();
        pkh.CopyTo(pk);
        CopyTo(pk, pkh);
    ...
    public static GameData3PK8? TryCreate(PH3 pkh)
    {
        if (pkh.DataPB7 is { } x)
    ...
    private static GameData3PK8 CreateViaPB7(PH3 pkh, GameData3PB7 x)
    {
        var result = new GameData3PK8();
    ...
    private static GameData3PK8 Create(IGameDataSide3 side, PH3 pkh)
    {
        var result = new GameData3PK8();
