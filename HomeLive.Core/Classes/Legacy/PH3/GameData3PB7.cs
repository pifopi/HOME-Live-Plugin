 ...
 * https://github.com/kwsch/PKHeX/blob/e41797d0cbec195577a993e97e79e979c2e97ce3/PKHeX.Core/PKM/HOME/GameDataPB7.cs
 * GPL v3 License
...
/// </summary>
public sealed class GameData3PB7 : HomeOptional3, IGameDataSide3<PB7>, IScaledSizeAbsolute, IGameDataSplitAbility
{
    ...
    public GameData3PB7() : base(SIZE) { }
    public GameData3PB7(Memory<byte> data) : base(data) => EnsureSize(SIZE);
    public GameData3PB7 Clone() => new(ToArray());
    ...
    public void CopyTo(PB7 pk, PH3 pkh)
    {
        this.CopyTo(pk);
        pk.AV_HP = AV_HP;
        pk.AV_ATK = AV_ATK;
    ...
    public void CopyFrom(PB7 pk, PH3 pkh)
    {
        this.CopyFrom(pk);
        AV_HP = pk.AV_HP;
        AV_ATK = pk.AV_ATK;
    ...
    public PB7 ConvertToPKM(PH3 pkh)
    {
        var pk = new PB7();
        pkh.CopyTo(pk);
        CopyTo(pk, pkh);
    ...
    public static GameData3PB7? TryCreate(PH3 pkh)
    {
    ...
    private static GameData3PB7? CreateInternal(PH3 pkh)
    {
        ...
        if (pkh.Version is GameVersion.GO)
            return new GameData3PB7 { Ball = ball, MetLocation = Locations.GO7 };
        if (pkh.Version is GameVersion.GP or GameVersion.GE)
            return new GameData3PB7 { Ball = ball, MetLocation = side.MetLocation };

        var result = new GameData3PB7();
        result.InitializeFrom(side, pkh);
        return result;
    }

    public void InitializeFrom(IGameDataSide3 side, PH3 pkh)
    {
    ...
    private void PopulateFromCore(PH3 pkh)
    {
    ...
    private static IGameDataSide3? GetNearestNeighbor(PH3 pkh) => pkh.DataPK9 as IGameDataSide3
                                                              ?? pkh.DataPB8 as IGameDataSide3
                                                              ?? pkh.DataPK8 as IGameDataSide3
                                                              ?? pkh.DataPB7;

    public static T Create<T>(GameData3PB7 data) where T : IGameDataSide3, new() => new()
    {
        Ball = data.Ball,
